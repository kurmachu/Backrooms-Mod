...
public class mcreator_pipesStraight extends thebackrooms.ModElement {

	@GameRegistry.ObjectHolder("thebackrooms:pipesstraight")
	public static final Block block = null;

	public mcreator_pipesStraight(thebackrooms instance) {
		super(instance);
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("thebackrooms:pipesstraight",
				"inventory"));
	}

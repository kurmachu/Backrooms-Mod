...
public class mcreator_VarListthebackrooms {

	public static class MapVariables extends WorldSavedData {

		private static final String DATA_NAME = "thebackrooms_mapvars";
	...
	public static class WorldVariables extends WorldSavedData {
		...
		private static final String DATA_NAME = "thebackrooms_worldvars";
